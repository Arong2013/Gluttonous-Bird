...
public class PlayerInteractionHandler : CharacterInteractionHandler
{
    ...
    public PlayerInteractionHandler(PlayerMarcine playerMarcine, Rigidbody rigidbody) : base(playerMarcine, rigidbody) { PlayerMarcine = playerMarcine; }
    ...
    public override void Climb()
    {
        ...
        if (dirY > 0)
            ...
            dir = Vector3.down;
        Vector3 climbMovement = characterMarcine.transform.position + dir * 15f * Time.deltaTime;
